                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
                        <tr>
                            @foreach ([
                                ...
                                'linkedin' => ['label' => 'LinkedIn', 'path' => 'M6.188 8.25A1.313 1.313 0 1 0 6.188 5.625A1.313 1.313 0 0 0 6.188 8.25ZM4.875 9.75H7.5V18.375H4.875V9.75ZM9 9.75H11.516V10.928H11.551C11.901 10.263 12.758 9.562 14.031 9.562C16.688 9.562 17.156 11.312 17.156 13.59V18.375H14.531V14.145C14.531 13.137 14.512 11.839 13.125 11.839C11.719 11.839 11.5 12.938 11.5 14.07V18.375H8.875V9.75H9Z'],
