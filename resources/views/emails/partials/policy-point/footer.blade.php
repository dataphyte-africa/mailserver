...
<tr>
    <td style="background-color:#f6f2eb;padding:30px 32px;border-top:1px solid #e7ddd1;">
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            @if(!empty($author))
                <tr>
                    <td style="padding:0 0 18px;text-align:center;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:12px;line-height:1.6;color:#6b7280;">
                        Written by <strong style="color:#1f2937;">{{ $author }}</strong>
                    </td>
                </tr>
            @endif
