@php
    $productName = $productName ?? 'Dataphyte Insight';
                ...
                <tr>
                    <td style="padding:24px 0;">
                        ...
                        <h2 style="margin:0 0 12px;font-family:Georgia,'Times New Roman',serif;font-size:28px;line-height:1.2;color:#0d1b2a;">
                            <a href="{{ $lead['url'] }}" target="_blank" rel="noopener noreferrer" style="color:#0d1b2a;text-decoration:none;">{{ $lead['title'] }}</a>
                        </h2>
                        ...
                        @endif
                        <a href="{{ $lead['url'] }}" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:12px 22px;background:#0d1b2a;color:#ffffff;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;font-weight:700;text-decoration:none;border-radius:2px;">
                            Read Story
                        </a>
                    </td>
                </tr>
